...
class Package {
    ...
    factory Package.fromJson(Map<String, dynamic> json) => Package(
        ...
        testling: Testling.fromJson(json["testling"]),
    );
...
class Dependencies {
    String balancedMatch;
    String concatMap;

    Dependencies({
        required this.balancedMatch,
        required this.concatMap,
    });

    factory Dependencies.fromJson(Map<String, dynamic> json) => Dependencies(
        balancedMatch: json["balanced-match"],
        concatMap: json["concat-map"],
    );

    Map<String, dynamic> toJson() => {
        "balanced-match": balancedMatch,
...
class DevDependencies {
    ...
    factory DevDependencies.fromJson(Map<String, dynamic> json) => DevDependencies(
        matcha: json["matcha"],
        tape: json["tape"],
    );
...
class Scripts {
    ...
    Scripts({
        required this.test,
        required this.gentest,
        required this.bench,
    });

    factory Scripts.fromJson(Map<String, dynamic> json) => Scripts(
        test: json["test"],
        gentest: json["gentest"],
        bench: json["bench"],
    );
...
class Testling {
    ...
    factory Testling.fromJson(Map<String, dynamic> json) => Testling(
        files: json["files"],
        browsers: List<String>.from(json["browsers"].map((x) => x)),
    );

    Map<String, dynamic> toJson() => {
        "files": files,
        "browsers": List<dynamic>.from(browsers.map((x) => x)),
    };
}
